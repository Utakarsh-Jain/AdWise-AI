...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 h-screen bg-slate-950/80 border-r border-slate-800 text-slate-200 flex flex-col justify-between backdrop-blur-md sticky top-0">
      {/* Brand Logo */}
      <div className="p-6 border-b border-slate-900">
        <Link href="/dashboard" className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-lg leading-none bg-gradient-to-r from-white via-slate-200 to-indigo-400 bg-clip-text text-transparent">
              AdWise AI
            </h1>
      ...
      <div className="p-4 border-t border-slate-900 bg-slate-950/40 space-y-3">
        ...
        <button
          onClick={logout}
          className="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-xs font-semibold text-rose-400 hover:bg-rose-500/10 transition-all duration-300 border border-transparent hover:border-rose-500/20"
        >
