    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-zinc-950 p-4 sm:p-6 md:p-8 relative overflow-hidden transition-colors">
      ...
      <div className="w-full max-w-4xl min-h-[580px] bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800/80 rounded-3xl overflow-hidden shadow-xl dark:shadow-none flex flex-col md:flex-row relative z-10">
          ...
          <div className="relative z-10 space-y-8 my-auto py-8">
            <div>
              <h1 className="text-3xl font-extrabold text-white leading-tight tracking-tight">
                ...
                <span className="text-zinc-550">Better results.</span>
              </h1>
              <p className="mt-4 text-zinc-400 text-xs leading-relaxed">
                AI-powered analytics that help you optimize ad spend, forecast performance, and grow revenue.
              </p>
            </div>

            <div className="space-y-3">
              {[
                { icon: Zap, text: 'AI-powered budget optimization' },
                { icon: TrendingUp, text: 'Revenue forecasting & projections' },
        ...
        <div className="md:hidden bg-zinc-950 dark:bg-black px-6 py-8 text-center border-b border-zinc-800 shrink-0">
          ...
          <p className="text-zinc-400 text-xs mt-1">Sign in to your account</p>
        </div>
          ...
          <div className="w-full max-w-[340px] mx-auto">
            ...
            <div className="hidden md:block">
              ...
              <p className="mt-1.5 text-xs text-zinc-500 dark:text-zinc-400">
                ...
                <Link href="/signup" className="text-zinc-900 dark:text-white hover:underline font-semibold decoration-zinc-400 underline-offset-4">
                  Sign up
                </Link>
              </p>
            </div>
